...
tabPanel(
  ...
  fluidRow(column(width = 4, selectInput(inputId = "A_Sem", label = h4("Semantic class of A"), 
          ...
          column(width = 4, selectInput(inputId = "A_Ident", label = h4("Identifiability of A"), 
                                choices = list("Generic use" = "A_Gen", "A is unique in its kind, anaphoric or identifiable from context" = "A_Def", "One can replace A with 'a certain/particular A'" = "A_Spec", "Other" = "A_NonSpec", "Difficult to say" = "A_UndefIdent", "Not applicable (interrogative and impersonal pronouns, clauses, etc.)" = "A_NAIdent"), 
                                selected = 1)
                 ),
...
tabPanel(
    ...
    fluidRow(column(width = 4,selectInput(inputId = "P_Sem", label = h4("Semantic class of P"), 
     ...
     column(width = 4, selectInput(inputId = "P_Ident", label = h4("Identifiability of P"), 
                                           choices = list("Generic use" = "P_Gen", "P is unique in its kind, anaphoric or identifiable from context" = "P_Def", "One can replace P with 'a certain/particular P'" = "P_Spec", "Other" = "P_NonSpec", "Difficult to say" = "P_UndefIdent", "Not applicable (interrogative and impersonal pronouns, clauses, etc.)" = "P_NAIdent"), 
                                           selected = 1)
            ),
